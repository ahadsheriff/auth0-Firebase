/**
 * Control the whole UI app and to sign into Firebase with a custom token.
 */

// where the app will show messages:
const chatArea = document.getElementById('chat-area');
// where users will type messages
const messageInput = document.getElementById('message');
// where the app will show the name of the logged-in user
